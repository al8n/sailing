...
Merge remains deferred: it couples two groups' logs through a freeze/handoff protocol split
never needed. Split shipped without shaping the Phase-0 container — the endpoint stages, the
container relays, the drivers materialize; the container stayed the pure routing layer.
