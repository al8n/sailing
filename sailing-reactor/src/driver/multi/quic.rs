  ...
  F::Error: core::error::Error,
{
  ...
  /// fails with the group-scoped teardown verdict. `Ok` carries whether the group was hosted; a
  /// group still owing an aborted merge its thaw refuses TRANSIENTLY ([`DriverError::Rejected`],
  /// the coordinator's inherited `OwesThaw`), tearing nothing down.
